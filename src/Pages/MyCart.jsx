...
function MyCart() {
  ...
  useEffect(() => {
    if (user) {
      ...
      fetch(`https://technology-and-electronics-server-side-o3w7iypcd.vercel.app/cart/${userEmail}`)
  ...
  const handleCartProductDelete = (id) => {
    fetch(`https://technology-and-electronics-server-side-o3w7iypcd.vercel.app/cart/${id}`, {
      method: 'DELETE',
    })
      .then((res) => res.json())
      .then((data) => {
