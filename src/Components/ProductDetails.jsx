...
const ProductDetails = () => {
  ...
  useEffect(() => {
    fetch(`https://technology-and-electronics-server-side-o3w7iypcd.vercel.app/product/${id}`)
  ...
  const addToCart = () => {
    if (product && user) {
      ...
      fetch('https://technology-and-electronics-server-side-o3w7iypcd.vercel.app/add-to-cart', {
        method: 'POST',
        headers: {
